	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  ...
			  <!--<a class="nav-link" id="v-pills-register-tab" data-toggle="pill" href="#v-pills-register" role="tab" aria-controls="v-pills-register" aria-selected="false">Register</a> <a href="url">link text</a>-->
			</div>
		</div>
		 <div class="col-lg-10">
				  ...
				  <div class="card-body">
					...
					<form>
					  <div class="form-row">
					    ...
					    <div class="form-group col-md-3">
						  <label for="purchaseDetailsPurchaseDate">Expiry Date<span class="requiredIcon">*</span></label>
						  <input type="text" class="form-control datepicker" id="purchaseDetailsPurchaseDate" name="purchaseDetailsPurchaseDate" readonly value="2018-05-24">
						</div>
					  </div>
					  <div class="form-row"> 
